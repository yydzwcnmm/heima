...
"color: rgb(255, 255, 255);"));
        ...
        btn_reg = new QToolButton(widget_5);
        btn_reg->setObjectName(QString::fromUtf8("btn_reg"));
        btn_reg->setGeometry(QRect(160, 250, 150, 35));
...
"border-image: url(:/images/balckButton.png);"));
        ...
        layoutWidget2->setGeometry(QRect(100, 100, 271, 141));
        ...
        gridLayout_2->addWidget(reg_pwd, 2, 1, 1, 1);
        ...
        gridLayout_2->addWidget(reg_pwd2, 3, 1, 1, 1);
        ...
        gridLayout_2->addWidget(reg_email, 4, 1, 1, 1);
