...
const uint32_t TableStruct_1_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Persion, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::Persion, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::Persion, _impl_.sex_),
  PROTOBUF_FIELD_OFFSET(::Persion, _impl_.age_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Persion)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::_Persion_default_instance_._instance,
};
...
const ::_pbi::DescriptorTable descriptor_table_1_2eproto = {
    false, false, 80, descriptor_table_protodef_1_2eproto,
    "1.proto",
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Persion.sex"));
        } else
          goto handle_unusual;
        continue;
      // int32 age = 4;
...
template<> PROTOBUF_NOINLINE ::Persion*
Arena::CreateMaybeMessage< ::Persion >(Arena* arena) {
